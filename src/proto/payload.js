...
const $root = $protobuf.roots["libp2p-noise"] || ($protobuf.roots["libp2p-noise"] = {});
...
export const pb = $root.pb = (() => {
    ...
    pb.NoiseHandshakePayload = (function() {
        ...
        NoiseHandshakePayload.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.NoiseHandshakePayload();
        ...
        NoiseHandshakePayload.fromObject = function fromObject(object) {
            if (object instanceof $root.pb.NoiseHandshakePayload)
                return object;
            let message = new $root.pb.NoiseHandshakePayload();
